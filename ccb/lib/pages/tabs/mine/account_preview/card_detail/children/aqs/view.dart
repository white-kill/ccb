...
class AqsPage extends BaseStateless {
  AqsPage({Key? key}) : super(key: key);

  final AqsLogic logic = Get.put(AqsLogic());
  final AqsState state = Get.find<AqsLogic>().state;
      ...
      child: ListView(
        children: [
          Stack(
            children: [
              Image.asset(
                'assets/new_images/home/account/detail/children/aqs.png',
                width: double.infinity,
                fit: BoxFit.fitWidth,
              ),
              Positioned(
                  top: screenWidth / 3240 * 7120 * 0.146,
