...
class ZhsjjPage extends BaseStateless {
  ZhsjjPage({Key? key}) : super(key: key);

  final ZhsjjLogic logic = Get.put(ZhsjjLogic());
  final ZhsjjState state = Get.find<ZhsjjLogic>().state;
      ...
      child: ListView(
        children: [
          Stack(
            children: [
              Image.asset(
                'assets/new_images/home/account/detail/children/zhsjj.png',
                width: double.infinity,
                fit: BoxFit.fitWidth,
              ),
              Positioned(
                top: screenWidth/3240 * 6084 * 0.022,
