...
class _TabBarView4State extends State<TabBarView4> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return list.isEmpty
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                BaseText(text: model.busType,fontSize: 15.sp,),
                BaseText(text: '已完成',    color: Color(0xFF3040A5),),
              ],
            ),
            BaseText(text: model.bankCard.maskBankCardNumber(),color: Color(0xff666666),).withPadding(
              top: 10.w,
              bottom: 10.w,
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                BaseText(text: '提交日期：${model.createTime}',color: Color(0xff666666),),
                BaseText(text: '提取码：${model.code}',color: Color(0xff666666),),
              ],
            ),
            SizedBox(height: 6.w,),
            Divider(
        ...
        Get.to(() => PrintProgressInfoPage(),arguments: {
          'model':model.detail
        });
      });
